...
public class GetParamInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("getParamInfoTestData");
	}
	...
	@Test
	public void testGetParamInfo() throws Exception {
		runFlowAndGetPayload("get-param-info");
	}
