...
public class GetmainModuleTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		initializeTestRunMessage("getmainModuleTestData");
	}
	...
	@Test
	public void testGetmainModule() throws Exception {
		runFlowAndGetPayload("getmain-module");
	}
