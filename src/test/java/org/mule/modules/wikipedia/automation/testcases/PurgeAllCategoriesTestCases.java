...
public class PurgeAllCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeAllCategoriesTestData");
	}
	...
	@Test
	public void testPurgeAllCategories() throws Exception {
		runFlowAndGetPayload("purge-all-categories");
	}
