...
public class PurgeAllDeletedRevisionsTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeAllDeletedRevisionsTestData");
    }
    ...
    @Test
    public void testPurgeAllDeletedRevisions()
        throws Exception
    {
        runFlowAndGetPayload("purge-all-deleted-revisions");
    }
