...
public class PurgeAllFileUsagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeAllFileUsagesTestData");
	}
	...
	@Test
	public void testPurgeAllFileUsages() throws Exception {
		runFlowAndGetPayload("purge-all-file-usages");
	}
