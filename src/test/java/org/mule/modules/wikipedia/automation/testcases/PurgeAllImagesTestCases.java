...
public class PurgeAllImagesTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeAllImagesTestData");
    }
    ...
    @Test
    public void testPurgeAllImages()
        throws Exception
    {
        runFlowAndGetPayload("purge-all-images");
    }
