...
public class PurgeAllPagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeAllPagesTestData");
	}
	...
	@Test
	public void testPurgeAllPages() throws Exception {
		runFlowAndGetPayload("purge-all-pages");
	}
