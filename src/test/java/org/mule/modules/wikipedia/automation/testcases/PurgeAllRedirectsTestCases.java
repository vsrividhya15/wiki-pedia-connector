...
public class PurgeAllRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeAllRedirectsTestData");
	}
	...
	@Test
	public void testPurgeAllRedirects() throws Exception {
		runFlowAndGetPayload("purge-all-redirects");
	}
