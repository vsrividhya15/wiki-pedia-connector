...
public class PurgeAllTransclusionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeAllTransclusionsTestData");
	}
	...
	@Test
	public void testPurgeAllTransclusions() throws Exception {
		runFlowAndGetPayload("purge-all-transclusions");
	}
