...
public class PurgeBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeBackLinksTestData");
	}
	...
	@Test
	public void testPurgeBackLinks() throws Exception {
		runFlowAndGetPayload("purge-back-links");
	}
