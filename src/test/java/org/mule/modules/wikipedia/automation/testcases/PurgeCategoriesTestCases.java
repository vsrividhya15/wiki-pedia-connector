...
public class PurgeCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeCategoriesTestData");
	}
	...
	@Test
	public void testPurgeCategories() throws Exception {
		runFlowAndGetPayload("purge-categories");
	}
