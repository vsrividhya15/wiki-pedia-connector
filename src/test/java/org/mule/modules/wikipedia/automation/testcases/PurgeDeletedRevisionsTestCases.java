...
public class PurgeDeletedRevisionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeDeletedRevisionsTestData");
	}
	...
	@Test
	public void testPurgeDeletedRevisions() throws Exception {
		runFlowAndGetPayload("purge-deleted-revisions");
	}
