...
public class PurgeDuplicateFilesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeDuplicateFilesTestData");
	}
	...
	@Test
	public void testPurgeDuplicateFiles() throws Exception {
		runFlowAndGetPayload("purge-duplicate-files");
	}
