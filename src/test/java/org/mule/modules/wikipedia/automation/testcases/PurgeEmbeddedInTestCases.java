...
public class PurgeEmbeddedInTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeEmbeddedInTestData");
	}
	...
	@Test
	public void testPurgeEmbeddedIn() throws Exception {
		runFlowAndGetPayload("purge-embedded-in");
	}
