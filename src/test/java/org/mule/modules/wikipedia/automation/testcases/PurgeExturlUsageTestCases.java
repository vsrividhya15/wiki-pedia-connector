...
public class PurgeExturlUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeExturlUsageTestData");
	}
	...
	@Test
	public void testPurgeExturlUsage() throws Exception {
		runFlowAndGetPayload("purge-exturl-usage");
	}
