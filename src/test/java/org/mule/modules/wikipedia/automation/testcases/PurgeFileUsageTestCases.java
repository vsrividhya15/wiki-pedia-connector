...
public class PurgeFileUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeFileUsageTestData");
	}
	...
	@Test
	public void testPurgeFileUsage() throws Exception {
		runFlowAndGetPayload("purge-file-usage");
	}
