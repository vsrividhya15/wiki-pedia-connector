...
public class PurgeImageUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeImageUsageTestData");
	}
	...
	@Test
	public void testPurgeImageUsage() throws Exception {
		runFlowAndGetPayload("purge-image-usage");
	}
