...
public class PurgeLangBackLinksTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeLangBackLinksTestData");
    }
    ...
    @Test
    public void testPurgeLangBackLinks()
        throws Exception
    {
        runFlowAndGetPayload("purge-lang-back-links");
    }
