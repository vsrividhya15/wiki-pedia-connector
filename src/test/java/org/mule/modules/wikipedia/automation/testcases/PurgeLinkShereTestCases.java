...
public class PurgeLinkShereTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeLinkShereTestData");
	}
	...
	@Test
	public void testPurgeLinkShere() throws Exception {
		runFlowAndGetPayload("purge-link-shere");
	}
