...
public class PurgeMessageCollectionTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeMessageCollectionTestData");
    }
    ...
    @Test
    public void testPurgeMessageCollection()
        throws Exception
    {
        runFlowAndGetPayload("purge-message-collection");
    }
