...
public class PurgePagesWithPropTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgePagesWithPropTestData");
    }
    ...
    @Test
    public void testPurgePagesWithProp()
        throws Exception
    {
        runFlowAndGetPayload("purge-pages-with-prop");
    }
