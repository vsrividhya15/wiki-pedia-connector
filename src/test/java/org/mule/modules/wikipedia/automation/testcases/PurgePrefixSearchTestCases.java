...
public class PurgePrefixSearchTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgePrefixSearchTestData");
    }
    ...
    @Test
    public void testPurgePrefixSearch()
        throws Exception
    {
        runFlowAndGetPayload("purge-prefix-search");
    }
