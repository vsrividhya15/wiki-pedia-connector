...
public class PurgeProtectedTitlesTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeProtectedTitlesTestData");
    }
    ...
    @Test
    public void testPurgeProtectedTitles()
        throws Exception
    {
        runFlowAndGetPayload("purge-protected-titles");
    }
