...
public class PurgeQueryPageTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("purgeQueryPageTestData");
    }
    ...
    @Test
    public void testPurgeQueryPage()
        throws Exception
    {
        runFlowAndGetPayload("purge-query-page");
    }
