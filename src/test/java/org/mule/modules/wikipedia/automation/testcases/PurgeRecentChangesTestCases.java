...
public class PurgeRecentChangesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeRecentChangesTestData");
	}
	...
	@Test
	public void testPurgeRecentChanges() throws Exception {
		runFlowAndGetPayload("purge-recent-changes");
	}
