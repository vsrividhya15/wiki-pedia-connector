...
public class PurgeRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeRedirectsTestData");
	}
	...
	@Test
	public void testPurgeRedirects() throws Exception {
		runFlowAndGetPayload("purge-redirects");
	}
