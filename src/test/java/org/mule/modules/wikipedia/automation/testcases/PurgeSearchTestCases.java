...
public class PurgeSearchTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeSearchTestData");
	}
	...
	@Test
	public void testPurgeSearch() throws Exception {
		runFlowAndGetPayload("purge-search");
	}
