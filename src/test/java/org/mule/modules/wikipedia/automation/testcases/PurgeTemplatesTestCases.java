...
public class PurgeTemplatesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeTemplatesTestData");
	}
	...
	@Test
	public void testPurgeTemplates() throws Exception {
		runFlowAndGetPayload("purge-templates");
	}
