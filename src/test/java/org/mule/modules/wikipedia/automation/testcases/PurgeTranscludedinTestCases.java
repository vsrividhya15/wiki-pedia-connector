...
public class PurgeTranscludedinTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeTranscludedinTestData");
	}
	...
	@Test
	public void testPurgeTranscludedin() throws Exception {
		runFlowAndGetPayload("purge-transcludedin");
	}
