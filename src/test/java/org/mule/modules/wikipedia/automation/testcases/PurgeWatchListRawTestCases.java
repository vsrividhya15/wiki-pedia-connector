...
public class PurgeWatchListRawTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeWatchListRawTestData");
	}
	...
	@Test
	public void testPurgeWatchListRaw() throws Exception {
		runFlowAndGetPayload("purge-watch-list-raw");
	}
