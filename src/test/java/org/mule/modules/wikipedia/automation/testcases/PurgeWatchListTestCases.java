...
public class PurgeWatchListTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("purgeWatchListTestData");
	}
	...
	@Test
	public void testPurgeWatchList() throws Exception {
		runFlowAndGetPayload("purge-watch-list");
    }
