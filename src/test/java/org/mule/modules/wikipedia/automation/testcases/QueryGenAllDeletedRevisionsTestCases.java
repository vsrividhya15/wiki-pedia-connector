...
public class QueryGenAllDeletedRevisionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllDeletedRevisionsTestData");
	}
	...
	@Test
	public void testQueryGenAllDeletedRevisions() throws Exception {
		runFlowAndGetPayload("query-gen-all-deleted-revisions");
	}
