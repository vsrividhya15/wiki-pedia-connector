...
public class QueryGenAllFileUsagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllFileUsagesTestData");
	}
	...
	@Test
	public void testQueryGenAllFileUsages() throws Exception {
		runFlowAndGetPayload("query-gen-all-file-usages");
	}
