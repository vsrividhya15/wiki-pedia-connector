...
public class QueryGenAllImagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllImagesTestData");
	}
	...
	@Test
	public void testQueryGenAllImages() throws Exception {
		runFlowAndGetPayload("query-gen-all-images");
	}
