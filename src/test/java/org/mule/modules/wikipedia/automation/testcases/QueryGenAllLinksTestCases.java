...
public class QueryGenAllLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllLinksTestData");
	}
	...
	@Test
	public void testQueryGenAllLinks() throws Exception {
		runFlowAndGetPayload("query-gen-all-links");
	}
