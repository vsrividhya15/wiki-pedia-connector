...
public class QueryGenAllPagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllPagesTestData");
	}
	...
	@Test
	public void testQueryGenAllPages() throws Exception {
		runFlowAndGetPayload("query-gen-all-pages");
	}
