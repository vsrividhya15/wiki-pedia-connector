...
public class QueryGenAllRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllRedirectsTestData");
	}
	...
	@Test
	public void testQueryGenAllRedirects() throws Exception {
		runFlowAndGetPayload("query-gen-all-redirects");
	}
