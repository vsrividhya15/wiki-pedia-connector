...
public class QueryGenAllTransclusionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllTransclusionsTestData");
	}
	...
	@Test
	public void testQueryGenAllTransclusions() throws Exception {
		runFlowAndGetPayload("query-gen-all-transclusions");
	}
