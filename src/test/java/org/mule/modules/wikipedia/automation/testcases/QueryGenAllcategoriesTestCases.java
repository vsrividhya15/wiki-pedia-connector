...
public class QueryGenAllcategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenAllcategoriesTestData");
	}
	...
	@Test
	public void testQueryGenAllcategories() throws Exception {
		runFlowAndGetPayload("query-gen-allcategories");
	}
