...
public class QueryGenBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenBackLinksTestData");
	}
	...
	@Test
	public void testQueryGenBackLinks() throws Exception {
		runFlowAndGetPayload("query-gen-back-links");
	}
