...
public class QueryGenCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenCategoriesTestData");
	}
	...
	@Test
	public void testQueryGenCategories() throws Exception {
		runFlowAndGetPayload("query-gen-categories");
	}
