...
public class QueryGenCategoryMembersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenCategoryMembersTestData");
	}
	...
	@Test
	public void testQueryGenCategoryMembers() throws Exception {
		runFlowAndGetPayload("query-gen-category-members");
	}
