...
public class QueryGenDuplicateFilesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenDuplicateFilesTestData");
	}
	...
	@Test
	public void testQueryGenDuplicateFiles() throws Exception {
		runFlowAndGetPayload("query-gen-duplicate-files");
	}
