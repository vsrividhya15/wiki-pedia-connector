...
public class QueryGenEmbeddedInTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenEmbeddedInTestData");
	}
	...
	@Test
	public void testQueryGenEmbeddedIn() throws Exception {
		runFlowAndGetPayload("query-gen-embedded-in");
	}
