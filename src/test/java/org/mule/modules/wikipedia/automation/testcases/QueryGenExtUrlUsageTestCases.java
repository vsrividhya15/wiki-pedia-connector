...
public class QueryGenExtUrlUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenExtUrlUsageTestData");
	}
	...
	@Test
	public void testQueryGenExtUrlUsage() throws Exception {
		runFlowAndGetPayload("query-gen-ext-url-usage");
	}
