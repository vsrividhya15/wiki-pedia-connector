...
public class QueryGenFileUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenFileUsageTestData");
	}
	...
	@Test
	public void testQueryGenFileUsage() throws Exception {
		runFlowAndGetPayload("query-gen-file-usage");
	}
