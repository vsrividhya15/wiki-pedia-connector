...
public class QueryGenImagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenImagesTestData");
	}
	...
	@Test
	public void testQueryGenImages() throws Exception {
		runFlowAndGetPayload("query-gen-images");
	}
