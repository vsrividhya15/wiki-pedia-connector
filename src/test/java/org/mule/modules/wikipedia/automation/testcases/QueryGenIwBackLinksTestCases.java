...
public class QueryGenIwBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenIwBackLinksTestData");
	}
	...
	@Test
	public void testQueryGenIwBackLinks() throws Exception {
		runFlowAndGetPayload("query-gen-iw-back-links");
	}
