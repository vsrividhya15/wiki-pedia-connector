...
public class QueryGenLangBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenLangBackLinksTestData");
	}
	...
	@Test
	public void testQueryGenLangBackLinks() throws Exception {
		runFlowAndGetPayload("query-gen-lang-back-links");
	}
