...
public class QueryGenLinkShereTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenLinkShereTestData");
	}
	...
	@Test
	public void testQueryGenLinkShere() throws Exception {
		runFlowAndGetPayload("query-gen-link-shere");
	}
