...
public class QueryGenLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenLinksTestData");
	}
	...
	@Test
	public void testQueryGenLinks() throws Exception {
		runFlowAndGetPayload("query-gen-links");
	}
