...
public class QueryGenMessageCollectionTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenMessageCollectionTestData");
	}
	...
	@Test
	public void testQueryGenMessageCollection() throws Exception {
		runFlowAndGetPayload("query-gen-message-collection");
	}
