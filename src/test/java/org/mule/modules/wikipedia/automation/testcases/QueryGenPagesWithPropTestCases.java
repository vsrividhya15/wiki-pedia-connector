...
public class QueryGenPagesWithPropTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenPagesWithPropTestData");
	}
	...
	@Test
	public void testQueryGenPagesWithProp() throws Exception {
		runFlowAndGetPayload("query-gen-pages-with-prop");
	}
