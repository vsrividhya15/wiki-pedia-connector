...
public class QueryGenPrefixSearchTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenPrefixSearchTestData");
	}
	...
	@Test
	public void testQueryGenPrefixSearch() throws Exception {
		runFlowAndGetPayload("query-gen-prefix-search");
	}
