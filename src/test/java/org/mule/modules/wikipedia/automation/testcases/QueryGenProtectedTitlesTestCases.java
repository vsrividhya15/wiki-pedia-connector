...
public class QueryGenProtectedTitlesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenProtectedTitlesTestData");
	}
	...
	@Test
	public void testQueryGenProtectedTitles() throws Exception {
		runFlowAndGetPayload("query-gen-protected-titles");
	}
