...
public class QueryGenQueryPageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenQueryPageTestData");
	}
	...
	@Test
	public void testQueryGenQueryPage() throws Exception {
		runFlowAndGetPayload("query-gen-query-page");
	}
