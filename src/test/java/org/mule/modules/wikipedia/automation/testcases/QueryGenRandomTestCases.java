...
public class QueryGenRandomTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenRandomTestData");
	}
	...
	@Test
	public void testQueryGenRandom() throws Exception {
		runFlowAndGetPayload("query-gen-random");
	}
