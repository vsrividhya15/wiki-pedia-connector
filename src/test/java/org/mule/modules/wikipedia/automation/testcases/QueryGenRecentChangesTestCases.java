...
public class QueryGenRecentChangesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenRecentChangesTestData");
	}
	...
	@Test
	public void testQueryGenRecentChanges() throws Exception {
		runFlowAndGetPayload("query-gen-recent-changes");
	}
