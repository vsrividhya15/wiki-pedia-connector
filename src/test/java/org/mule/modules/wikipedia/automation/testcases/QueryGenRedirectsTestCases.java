...
public class QueryGenRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenRedirectsTestData");
	}
	...
	@Test
	public void testQueryGenRedirects() throws Exception {
		runFlowAndGetPayload("query-gen-redirects");
	}
