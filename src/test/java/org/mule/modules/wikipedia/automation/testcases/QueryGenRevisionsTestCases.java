...
public class QueryGenRevisionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenRevisionsTestData");
	}
	...
	@Test
	public void testQueryGenRevisions() throws Exception {
		runFlowAndGetPayload("query-gen-revisions");
	}
