...
public class QueryGenSearchTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenSearchTestData");
	}
	...
	@Test
	public void testQueryGenSearch() throws Exception {
		runFlowAndGetPayload("query-gen-search");
	}
