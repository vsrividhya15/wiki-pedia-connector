...
public class QueryGenTemplatesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenTemplatesTestData");
	}
	...
	@Test
	public void testQueryGenTemplates() throws Exception {
		runFlowAndGetPayload("query-gen-templates");
	}
