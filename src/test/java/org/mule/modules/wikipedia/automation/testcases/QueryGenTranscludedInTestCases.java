...
public class QueryGenTranscludedInTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenTranscludedInTestData");
	}
	...
	@Test
	public void testQueryGenTranscludedIn() throws Exception {
		runFlowAndGetPayload("query-gen-transcluded-in");
	}
