...
public class QueryGenWatchListRawTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenWatchListRawTestData");
	}
	...
	@Test
	public void testQueryGenWatchListRaw() throws Exception {
		runFlowAndGetPayload("query-gen-watch-list-raw");
	}
