...
public class QueryGenWatchListTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryGenWatchListTestData");
	}
	...
	@Test
	public void testQueryGenWatchList() throws Exception {
		runFlowAndGetPayload("query-gen-watch-list");
	}
