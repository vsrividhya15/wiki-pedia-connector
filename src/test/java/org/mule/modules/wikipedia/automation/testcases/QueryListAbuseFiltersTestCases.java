...
public class QueryListAbuseFiltersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAbuseFiltersTestData");
	}
	...
	@Test
	public void testQueryListAbuseFilters() throws Exception {
		runFlowAndGetPayload("query-list-abuse-filters");
	}
