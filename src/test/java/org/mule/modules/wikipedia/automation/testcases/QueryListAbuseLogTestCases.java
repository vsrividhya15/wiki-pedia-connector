...
public class QueryListAbuseLogTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAbuseLogTestData");
	}
	...
	@Test
	public void testQueryListAbuseLog() throws Exception {
		runFlowAndGetPayload("query-list-abuse-log");
	}
