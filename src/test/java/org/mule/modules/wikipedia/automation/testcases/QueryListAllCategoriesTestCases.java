...
public class QueryListAllCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllCategoriesTestData");
	}
	...
	@Test
	public void testQueryListAllCategories() throws Exception {
		runFlowAndGetPayload("query-list-all-categories");
	}
