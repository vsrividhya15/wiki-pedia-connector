...
public class QueryListAllDeletedRevisionsTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryListAllDeletedRevisions()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-all-deleted-revisions");
