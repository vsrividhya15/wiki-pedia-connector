...
public class QueryListAllDeletedRevisionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllDeletedRevisionsTestData");
	}
	...
	@Test
	public void testQueryListAllDeletedRevisions() throws Exception {
		runFlowAndGetPayload("query-list-all-deleted-revisions");
	}
