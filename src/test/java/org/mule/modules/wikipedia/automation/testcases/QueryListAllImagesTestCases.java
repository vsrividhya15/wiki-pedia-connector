...
public class QueryListAllImagesTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryListAllImages() throws Exception {
		runFlowAndGetPayload("query-list-all-images");
	}
