...
public class QueryListAllLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllLinksTestData");
	}
	...
	@Test
	public void testQueryListAllLinks() throws Exception {
		runFlowAndGetPayload("query-list-all-links");
	}
