...
public class QueryListAllPagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllPagesTestData");
	}
	...
	@Test
	public void testQueryListAllPages() throws Exception {
		runFlowAndGetPayload("query-list-all-pages");
	}
