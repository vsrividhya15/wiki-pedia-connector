...
public class QueryListAllRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllRedirectsTestData");
	}
	...
	@Test
	public void testQueryListAllRedirects() throws Exception {
		runFlowAndGetPayload("query-list-all-redirects");
	}
