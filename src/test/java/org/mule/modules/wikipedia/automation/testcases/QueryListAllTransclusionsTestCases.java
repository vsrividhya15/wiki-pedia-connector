...
public class QueryListAllTransclusionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllTransclusionsTestData");
	}
	...
	@Test
	public void testQueryListAllTransclusions() throws Exception {
		runFlowAndGetPayload("query-list-all-transclusions");
	}
