...
public class QueryListAllTransclusionsTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryListAllTransclusions()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-all-transclusions");
