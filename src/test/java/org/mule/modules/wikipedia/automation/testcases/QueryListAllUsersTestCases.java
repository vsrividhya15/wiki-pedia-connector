...
public class QueryListAllUsersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListAllUsersTestData");
	}
	...
	@Test
	public void testQueryListAllUsers() throws Exception {
		runFlowAndGetPayload("query-list-all-users");
	}
