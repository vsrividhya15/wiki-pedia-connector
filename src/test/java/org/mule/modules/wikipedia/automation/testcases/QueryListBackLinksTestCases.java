...
public class QueryListBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListBackLinksTestData");
	}
	...
	@Test
	public void testQueryListBackLinks() throws Exception {
		runFlowAndGetPayload("query-list-back-links");
	}
