...
public class QueryListBetaFeaturesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListBetaFeaturesTestData");
	}
	...
	@Test
	public void testQueryListBetaFeatures() throws Exception {
		runFlowAndGetPayload("query-list-beta-features");
	}
