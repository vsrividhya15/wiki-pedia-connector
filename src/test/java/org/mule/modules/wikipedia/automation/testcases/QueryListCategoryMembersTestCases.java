...
public class QueryListCategoryMembersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListCategoryMembersTestData");
	}
	...
	@Test
	public void testQueryListCategoryMembers() throws Exception {
		runFlowAndGetPayload("query-list-category-members");
	}
