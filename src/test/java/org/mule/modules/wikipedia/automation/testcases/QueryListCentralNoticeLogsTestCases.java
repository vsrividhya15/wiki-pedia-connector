...
public class QueryListCentralNoticeLogsTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryListCentralNoticeLogs()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-central-notice-logs");
