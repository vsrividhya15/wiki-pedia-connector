...
public class QueryListCentralNoticeLogsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListCentralNoticeLogsTestData");
	}
	...
	@Test
	public void testQueryListCentralNoticeLogs() throws Exception {
		runFlowAndGetPayload("query-list-central-notice-logs");
	}
