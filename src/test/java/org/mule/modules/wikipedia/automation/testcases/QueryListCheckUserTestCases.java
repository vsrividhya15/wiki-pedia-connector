...
public class QueryListCheckUserTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListCheckUserTestData");
	}
	...
	@Test
	public void testQueryListCheckUser() throws Exception {
		runFlowAndGetPayload("query-list-check-user");
	}
