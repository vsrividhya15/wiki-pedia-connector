...
public class QueryListEmbeddedInTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListEmbeddedInTestData");
	}
	...
	@Test
	public void testQueryListEmbeddedIn() throws Exception {
		runFlowAndGetPayload("query-list-embedded-in");
	}
