...
public class QueryListExturlusageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListExturlusageTestData");
	}
	...
	@Test
	public void testQueryListExturlusage() throws Exception {
		runFlowAndGetPayload("query-list-exturlusage");
	}
