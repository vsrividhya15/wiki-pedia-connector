...
public class QueryListFileArchiveTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryListFileArchive() throws Exception {
		runFlowAndGetPayload("query-list-file-archive");
	}
