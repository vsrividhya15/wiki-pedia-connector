...
public class QueryListGadgetCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListGadgetCategoriesTestData");
	}
	...
	@Test
	public void testQueryListGadgetCategories() throws Exception {
		runFlowAndGetPayload("query-list-gadget-categories");
	}
