...
public class QueryListGadgetCategoriesTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryListGadgetCategories()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-gadget-categories");
