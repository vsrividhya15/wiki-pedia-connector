...
public class QueryListGadgetsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListGadgetsTestData");
	}
	...
	@Test
	public void testQueryListGadgets() throws Exception {
		runFlowAndGetPayload("query-list-gadgets");
	}
