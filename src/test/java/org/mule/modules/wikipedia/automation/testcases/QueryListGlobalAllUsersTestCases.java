...
public class QueryListGlobalAllUsersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListGlobalAllUsersTestData");
	}
	...
	@Test
	public void testQueryListGlobalAllUsers() throws Exception {
		runFlowAndGetPayload("query-list-global-all-users");
	}
