...
public class QueryListGlobalBlocksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListGlobalBlocksTestData");
	}
	...
	@Test
	public void testQueryListGlobalBlocks() throws Exception {
		runFlowAndGetPayload("query-list-global-blocks");
	}
