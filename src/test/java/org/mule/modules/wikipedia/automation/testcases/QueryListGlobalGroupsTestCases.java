...
public class QueryListGlobalGroupsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListGlobalGroupsTestData");
	}
	...
	@Test
	public void testQueryListGlobalGroups() throws Exception {
		runFlowAndGetPayload("query-list-global-groups");
	}
