...
public class QueryListImageUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListImageUsageTestData");
	}
	...
	@Test
	public void testQueryListImageUsage() throws Exception {
		runFlowAndGetPayload("query-list-image-usage");
	}
