...
public class QueryListIwBackLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListIwBackLinksTestData");
	}
	...
	@Test
	public void testQueryListIwBackLinks() throws Exception {
		runFlowAndGetPayload("query-list-iw-back-links");
	}
