...
public class QueryListLogEventsTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryListLogEvents() throws Exception {
		runFlowAndGetPayload("query-list-log-events");
	}
