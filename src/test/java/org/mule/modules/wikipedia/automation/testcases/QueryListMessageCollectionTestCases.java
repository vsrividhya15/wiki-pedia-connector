...
public class QueryListMessageCollectionTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListMessageCollectionTestData");
	}
	...
	@Test
	public void testQueryListMessageCollection() throws Exception {
		runFlowAndGetPayload("query-list-message-collection");
	}
