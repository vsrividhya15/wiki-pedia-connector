...
public class QueryListMessageCollectionTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryListMessageCollection()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-message-collection");
