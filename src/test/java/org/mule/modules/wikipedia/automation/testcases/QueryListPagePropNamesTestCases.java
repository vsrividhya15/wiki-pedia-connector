...
public class QueryListPagePropNamesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListPagePropNamesTestData");
	}
	...
	@Test
	public void testQueryListPagePropNames() throws Exception {
		runFlowAndGetPayload("query-list-page-prop-names");
	}
