...
public class QueryListPageswithpropTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListPageswithpropTestData");
	}
	...
	@Test
	public void testQueryListPageswithprop() throws Exception {
		runFlowAndGetPayload("query-list-pageswithprop");
	}
