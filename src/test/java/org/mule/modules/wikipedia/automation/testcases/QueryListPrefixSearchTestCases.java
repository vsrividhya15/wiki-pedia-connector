...
public class QueryListPrefixSearchTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryListPrefixSearch() throws Exception {
		runFlowAndGetPayload("query-list-prefix-search");
	}
