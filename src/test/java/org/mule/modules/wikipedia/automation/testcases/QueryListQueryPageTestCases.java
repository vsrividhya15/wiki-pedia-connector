...
public class QueryListQueryPageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListQueryPageTestData");
	}
	...
	@Test
	public void testQueryListQueryPage() throws Exception {
		runFlowAndGetPayload("query-list-query-page");
	}
