...
public class QueryListRandomTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListRandomTestData");
	}
	...
	@Test
	public void testQueryListRandom() throws Exception {
		runFlowAndGetPayload("query-list-random");
	}
