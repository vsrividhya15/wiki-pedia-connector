...
public class QueryListSearchTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListSearchTestData");
	}
	...
	@Test
	public void testQueryListSearch() throws Exception {
		runFlowAndGetPayload("query-list-search");
	}
