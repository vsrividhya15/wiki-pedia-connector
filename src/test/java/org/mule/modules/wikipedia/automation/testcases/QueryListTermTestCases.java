...
public class QueryListTermTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListTermTestData");
	}
	...
	@Test
	public void testQueryListTerm() throws Exception {
		runFlowAndGetPayload("query-list-term");
	}
