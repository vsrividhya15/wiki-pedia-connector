...
public class QueryListUserContribsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListUserContribsTestData");
	}
	...
	@Test
	public void testQueryListUserContribs() throws Exception {
		runFlowAndGetPayload("query-list-user-contribs");
	}
