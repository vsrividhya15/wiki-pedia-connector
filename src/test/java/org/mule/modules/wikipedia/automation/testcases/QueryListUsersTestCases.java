...
public class QueryListUsersTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListUsersTestData");
	}
	...
	@Test
	public void testQueryListUsers() throws Exception {
		runFlowAndGetPayload("query-list-users");
	}
