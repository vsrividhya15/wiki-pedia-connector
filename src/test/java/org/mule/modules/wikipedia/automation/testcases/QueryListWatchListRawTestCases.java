...
public class QueryListWatchListRawTestCases
    extends WikiPediaTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("queryListWatchListRawTestData");
    }
    ...
    @Test
    public void testQueryListWatchListRaw()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-list-watch-list-raw");
