...
public class QueryListWikiSetsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListWikiSetsTestData");
	}
	...
	@Test
	public void testQueryListWikiSets() throws Exception {
		runFlowAndGetPayload("query-list-wiki-sets");
	}
