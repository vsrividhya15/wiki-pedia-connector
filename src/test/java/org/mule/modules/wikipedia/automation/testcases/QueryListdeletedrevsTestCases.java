...
public class QueryListdeletedrevsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListdeletedrevsTestData");
	}
	...
	@Test
	public void testQueryListdeletedrevs() throws Exception {
		 runFlowAndGetPayload("query-listdeletedrevs");
	}
