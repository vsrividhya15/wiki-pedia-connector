...
public class QueryListlangbacklinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryListlangbacklinksTestData");
	}
	...
	@Test
	public void testQueryListlangbacklinks() throws Exception {
		runFlowAndGetPayload("query-listlangbacklinks");
	}
