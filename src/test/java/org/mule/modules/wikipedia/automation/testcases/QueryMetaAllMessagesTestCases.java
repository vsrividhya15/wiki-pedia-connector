...
public class QueryMetaAllMessagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetaAllMessagesTestData");
	}
	...
	@Test
	public void testQueryMetaAllMessages() throws Exception {
		runFlowAndGetPayload("query-meta-all-messages");
	}
