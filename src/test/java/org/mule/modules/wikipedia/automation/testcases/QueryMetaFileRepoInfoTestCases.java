...
public class QueryMetaFileRepoInfoTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryMetaFileRepoInfo() throws Exception {
		runFlowAndGetPayload("query-meta-file-repo-info");
	}
