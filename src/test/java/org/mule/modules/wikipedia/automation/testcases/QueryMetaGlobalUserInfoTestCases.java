...
public class QueryMetaGlobalUserInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetaGlobalUserInfoTestData");
	}
	...
	@Test
	public void testQueryMetaGlobalUserInfo() throws Exception {
		runFlowAndGetPayload("query-meta-global-user-info");
	}
