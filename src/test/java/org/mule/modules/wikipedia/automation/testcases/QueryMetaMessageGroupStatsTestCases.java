...
public class QueryMetaMessageGroupStatsTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryMetaMessageGroupStats()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-meta-message-group-stats");
