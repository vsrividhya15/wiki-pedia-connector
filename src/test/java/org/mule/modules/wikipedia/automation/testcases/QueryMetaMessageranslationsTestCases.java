...
public class QueryMetaMessageranslationsTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryMetaMessageranslations() throws Exception {
		runFlowAndGetPayload("query-meta-messageranslations");
	}
