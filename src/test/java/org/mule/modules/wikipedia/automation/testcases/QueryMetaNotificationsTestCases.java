...
public class QueryMetaNotificationsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetaNotificationsTestData");
	}
	...
	@Test
	public void testQueryMetaNotifications() throws Exception {
		runFlowAndGetPayload("query-meta-notifications");
	}
