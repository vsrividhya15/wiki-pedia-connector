...
public class QueryMetaUserInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetaUserInfoTestData");
	}
	...
	@Test
	public void testQueryMetaUserInfo() throws Exception {
		runFlowAndGetPayload("query-meta-user-info");
	}
