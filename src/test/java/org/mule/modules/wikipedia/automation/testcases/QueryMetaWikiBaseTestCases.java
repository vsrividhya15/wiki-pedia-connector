...
public class QueryMetaWikiBaseTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetaWikiBaseTestData");
	}
	...
	@Test
	public void testQueryMetaWikiBase() throws Exception {
		runFlowAndGetPayload("query-meta-wiki-base");
	}
