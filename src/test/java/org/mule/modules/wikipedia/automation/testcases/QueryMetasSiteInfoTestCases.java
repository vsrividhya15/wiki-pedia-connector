...
public class QueryMetasSiteInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetasSiteInfoTestData");
	}
	...
	@Test
	public void testQueryMetasSiteInfo() throws Exception {
		runFlowAndGetPayload("query-metas-site-info");
	}
