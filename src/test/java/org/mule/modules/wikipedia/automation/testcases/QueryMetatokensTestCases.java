...
public class QueryMetatokensTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryMetatokensTestData");
	}
	...
	@Test
	public void testQueryMetatokens() throws Exception {
		runFlowAndGetPayload("query-metatokens");
	}
