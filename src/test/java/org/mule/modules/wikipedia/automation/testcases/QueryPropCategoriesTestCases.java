...
public class QueryPropCategoriesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropCategoriesTestData");
	}
	...
	@Test
	public void testQueryPropCategories() throws Exception {
		runFlowAndGetPayload("query-prop-categories");
	}
