...
public class QueryPropCategoryInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropCategoryInfoTestData");
	}
	...
	@Test
	public void testQueryPropCategoryInfo() throws Exception {
		runFlowAndGetPayload("query-prop-category-info");
	}
