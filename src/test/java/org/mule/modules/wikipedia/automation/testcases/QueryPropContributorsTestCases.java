...
public class QueryPropContributorsTestCases extends WikiPediaTestParent {
	...
	@Test
	public void testQueryPropContributors() throws Exception {
		runFlowAndGetPayload("query-prop-contributors");
	}
