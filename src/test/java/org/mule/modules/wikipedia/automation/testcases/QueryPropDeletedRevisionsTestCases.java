...
public class QueryPropDeletedRevisionsTestCases
    extends WikiPediaTestParent
{
    ...
    @Test
    public void testQueryPropDeletedRevisions()
        throws Exception
    {
        Object result = runFlowAndGetPayload("query-prop-deleted-revisions");
