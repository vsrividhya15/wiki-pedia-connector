...
public class QueryPropDuplicateFilesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropDuplicateFilesTestData");
	}
	...
	@Test
	public void testQueryPropDuplicateFiles() throws Exception {
		runFlowAndGetPayload("query-prop-duplicate-files");
	}
