...
public class QueryPropExtLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropExtLinksTestData");
	}
	...
	@Test
	public void testQueryPropExtLinks() throws Exception {
		runFlowAndGetPayload("query-prop-ext-links");
	}
