...
public class QueryPropExtractsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropExtractsTestData");
	}
	...
	@Test
	public void testQueryPropExtracts() throws Exception {
		runFlowAndGetPayload("query-prop-extracts");
	}
