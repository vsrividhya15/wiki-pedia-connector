...
public class QueryPropFileusageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropFileusageTestData");
	}
	...
	@Test
	public void testQueryPropFileusage() throws Exception {
		runFlowAndGetPayload("query-prop-fileusage");
	}
