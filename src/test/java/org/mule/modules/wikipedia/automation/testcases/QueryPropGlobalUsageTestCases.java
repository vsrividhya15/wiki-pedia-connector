...
public class QueryPropGlobalUsageTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropGlobalUsageTestData");
	}
	...
	@Test
	public void testQueryPropGlobalUsage() throws Exception {
		runFlowAndGetPayload("query-prop-global-usage");
	}
