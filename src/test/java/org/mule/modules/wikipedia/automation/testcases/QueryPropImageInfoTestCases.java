...
public class QueryPropImageInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropImageInfoTestData");
	}
	...
	@Test
	public void testQueryPropImageInfo() throws Exception {
		runFlowAndGetPayload("query-prop-image-info");
	}
