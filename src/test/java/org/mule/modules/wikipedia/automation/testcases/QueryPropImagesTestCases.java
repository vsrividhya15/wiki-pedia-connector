...
public class QueryPropImagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropImagesTestData");
	}
	...
	@Test
	public void testQueryPropImages() throws Exception {
		runFlowAndGetPayload("query-prop-images");
	}
