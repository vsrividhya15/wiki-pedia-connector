...
public class QueryPropInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropInfoTestData");
	}
	...
	@Test
	public void testQueryPropInfo() throws Exception {
		runFlowAndGetPayload("query-prop-info");
	}
