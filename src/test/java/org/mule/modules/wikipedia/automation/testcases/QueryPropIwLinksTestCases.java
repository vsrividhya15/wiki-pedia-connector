...
public class QueryPropIwLinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropIwLinksTestData");
	}
	...
	@Test
	public void testQueryPropIwLinks() throws Exception {
		runFlowAndGetPayload("query-prop-iw-links");
	}
