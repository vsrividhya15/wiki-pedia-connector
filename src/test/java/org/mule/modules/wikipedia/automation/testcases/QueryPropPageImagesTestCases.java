...
public class QueryPropPageImagesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropPageImagesTestData");
	}
	...
	@Test
	public void testQueryPropPageImages() throws Exception {
		runFlowAndGetPayload("query-prop-page-images");
	}
