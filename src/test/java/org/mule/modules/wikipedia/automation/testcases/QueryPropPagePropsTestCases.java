...
public class QueryPropPagePropsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropPagePropsTestData");
	}
	...
	@Test
	public void testQueryPropPageProps() throws Exception {
		runFlowAndGetPayload("query-prop-page-props");
	}
