...
public class QueryPropPageTermsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropPageTermsTestData");
	}
	...
	@Test
	public void testQueryPropPageTerms() throws Exception {
		runFlowAndGetPayload("query-prop-page-terms");
	}
