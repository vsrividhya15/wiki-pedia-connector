...
public class QueryPropRedirectsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropRedirectsTestData");
	}
	...
	@Test
	public void testQueryPropRedirects() throws Exception {
		runFlowAndGetPayload("query-prop-redirects");
	}
