...
public class QueryPropRevisionsTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropRevisionsTestData");
	}
	...
	@Test
	public void testQueryPropRevisions() throws Exception {
		runFlowAndGetPayload("query-prop-revisions");
	}
