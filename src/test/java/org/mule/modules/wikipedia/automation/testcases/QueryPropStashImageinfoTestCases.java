...
public class QueryPropStashImageinfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropStashImageinfoTestData");
	}
	...
	@Test
	public void testQueryPropStashImageinfo() throws Exception {
		runFlowAndGetPayload("query-prop-stash-imageinfo");
	}
