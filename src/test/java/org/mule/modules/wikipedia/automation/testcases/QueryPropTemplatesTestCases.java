...
public class QueryPropTemplatesTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropTemplatesTestData");
	}
	...
	@Test
	public void testQueryPropTemplates() throws Exception {
		runFlowAndGetPayload("query-prop-templates");
	}
