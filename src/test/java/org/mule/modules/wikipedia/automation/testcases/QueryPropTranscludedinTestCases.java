...
public class QueryPropTranscludedinTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropTranscludedinTestData");
	}
	...
	@Test
	public void testQueryPropTranscludedin() throws Exception {
		runFlowAndGetPayload("query-prop-transcludedin");
	}
