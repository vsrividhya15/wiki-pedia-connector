...
public class QueryPropVideoInfoTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryPropVideoInfoTestData");
	}
	...
	@Test
	public void testQueryPropVideoInfo() throws Exception {
		runFlowAndGetPayload("query-prop-video-info");
	}
