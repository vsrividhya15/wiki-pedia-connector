...
public class QueryProplinksTestCases extends WikiPediaTestParent {

	@Before
	public void setup() throws Exception {
		// TODO: Add setup required to run test or remove method
		initializeTestRunMessage("queryProplinksTestData");
	}
	...
	@Test
	public void testQueryProplinks() throws Exception {
		runFlowAndGetPayload("query-proplinks");
	}
