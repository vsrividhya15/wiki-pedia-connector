...
/**
 * A <code>WikiPediaConnectorLifecycleAdapter</code> is a wrapper around {@link WikiPediaConnector } that adds lifecycle methods to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.6.0", date = "2015-04-30T10:58:05+10:00", comments = "Build UNNAMED.2363.ef5c8a7")
public abstract class WikiPediaConnectorLifecycleAdapter
    extends WikiPediaConnectorMetadataAdapater
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(WikiPediaConnectorLifecycleAdapter.class);
